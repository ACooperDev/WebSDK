...
- setStartupJob(do c#), getAllCellNames(do c#), setCellName(do c#), createNewJob(do c#), getCellCondition (do c#), startupOnline (get/put do c#), setCellConcition (do c#), getLiveMode (do c#)

...
- setStartupJob(do in c#), getAllCellNames(do in c#), setCellName(done python), createNewJob(done python), getCellCondition (done python), startupOnline (get/put done python), setCellConcition (done python), getLiveMode (done in python)

...
- setStartupJob(do c#), getAllCellNames(do c#), setCellName(do c#), createNewJob(do c#), getCellCondition (do c#), startupOnline (get/put do c#), setCellConcition (done python), getLiveMode (done in python)
